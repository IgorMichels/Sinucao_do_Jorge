...
def gera_bolas():
        bolas = [Bola(PVector(180, 420), 8.5, 1, (255, 255, 255)),
         Bola(PVector(600,384), 8.5, 1, (255,255,0)),      
         Bola(PVector(600,402), 8.5, 1, (0,255,255)),
         Bola(PVector(600,420), 8.5, 1, (255,0,255)),
         Bola(PVector(600,438), 8.5, 1, (0,255,0)),
         Bola(PVector(600,456), 8.5, 1, (0,0,255)),
         Bola(PVector(599-8.5*3**(0.5),392.5), 8.5, 1, (255,69,0)),
         Bola(PVector(599-8.5*3**(0.5),410.5), 8.5, 1, (128,0,0)),
         Bola(PVector(599-8.5*3**(0.5),429.5), 8.5, 1, (0,128,0)),
         Bola(PVector(599-8.5*3**(0.5),447.5), 8.5, 1, (0,0,128)),
         Bola(PVector(598-17*3**(0.5),402), 8.5, 1, (218,165,32)),
         Bola(PVector(598-17*3**(0.5),420), 8.5, 1, (0,0,0)),
         Bola(PVector(598-17*3**(0.5),438), 8.5, 1, (75,0,130)),
         Bola(PVector(597-25.5*3**(0.5),429.5), 8.5, 1, (139,69,19)),
         Bola(PVector(597-25.5*3**(0.5),410.5), 8.5, 1, (169,169,169)),
